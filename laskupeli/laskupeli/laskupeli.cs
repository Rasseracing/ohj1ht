...
/// @version 22.01.2026
/// <summary>
///  laskupeli jossa hypitään hyppyristä ja yritetään tehä voltti
/// </summary>
public class Laskupeli : PhysicsGame
{
    ...
    private double _pyoriminen;
    private double _edellinenKulma;
    ...
    public void Näppäintoiminnot()
    {
        ...
        Keyboard.Listen(Key.S, ButtonState.Down, _laskija.Push, "hidastaa",
            new Vector(_laskija.Mass * -300, _laskija.Mass * 500));
    ...
    {
        PhysicsObject hyppyri =
            new PhysicsObject(Hyppyrikoot(RandomGen.NextInt(8)), Hyppyrikoot(RandomGen.NextInt(0, 6)));
